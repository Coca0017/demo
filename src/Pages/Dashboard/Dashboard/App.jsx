        ...
        <div className="overviewWrapper">
          ...
          <div className="earningsDiv">
            <DashCard
              ...
              Body={userData ? `GHS ${userData.TotalEarnings}` : "Loading..."}
            />
            <DashCard
              Title={"Total Referrals Earnings"}
              Body={
                userData ? `GHS ${userData.Referral_Earnings}` : "Loading..."
              }
            />
            <DashCard
              Title={"Total Daily Earning"}
              Body={userData ? `GHS ${userData.DailyEarnings}` : "Loading..."}
            />
          </div>
          ...
          <div className="secondDiv">
            ...
            <DashCard
              ...
              Body={userData ? `${userData.Investment_Plan}` : "Loading..."}
            />
            <DashCard Title={"Rank"} Body={"Rookie"} />
          </div>

          {userData?.Investment_Plan && userData.Investment_Plan !== "None" ? (
